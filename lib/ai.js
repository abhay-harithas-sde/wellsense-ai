...
- Reference specific metrics from the real-time data when relevant`;
  ...
  // Nutrition advice with REAL-TIME data
  async generateNutritionAdvice(userProfile, query, db = null) {
    ...
    const systemPrompt = `You are a nutrition expert for WellSense AI. Provide personalized nutrition advice based on the user's profile and REAL-TIME nutrition data.
...
Guidelines:
- Analyze the REAL-TIME nutrition data above
- Provide evidence-based nutrition advice
- Consider user's BMI and health goals
- Suggest balanced meal plans based on current intake
